...
if (Meteor.isClient) {
  Template.hello.students = function() {
    return Student.find({},{sort:{group:1,score:-1}});
  };
...
if (Meteor.isServer) {
  Meteor.startup(function() {
    ...
    Student.update('holder2',{$unset:{score:0}})
    Student.update('holder3',{$unset:{score:0}})
    Student.update('holder4',{$unset:{score:0}})
    Student.update('holder5',{$unset:{score:0}})
